import type { DiagramShape, Rect } from "../interfaces/index.js";
...
export function shapePathCommands(shape: DiagramShape, rect: Rect): ShapePathCommand[] {
...
export function tracePathCommands(
  context: Pick<CanvasRenderingContext2D, "moveTo" | "lineTo" | "bezierCurveTo" | "closePath">,
